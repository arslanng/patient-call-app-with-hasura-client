  ...
  return (
    <div className={styles.container}>
        <Row>
            ...
            <Col span={18} className={styles.logoRaven}><img src={logoRaven} alt="logo1" width="55" /><span className={styles.logoName}>Bu uygulama Dr. Murat Gökduman tarafından kodlanmıştır.</span></Col>
